...
Game.registerMod("BackForSeconds", {
  init:function(){
    ...
    makeShadow("Industrial sprawl","Obtain a single building special with a duration of <b>40 minutes</b>. <q>Who the hell starts a combo like that? I just sat down!</q>",[4,5,'https://file.garden/aRv22xnkRhEaeVoP/bfs%202'])
